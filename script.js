    ...
    Корневище: {
        Бар: {
            Алкоголь: {
                ...
                Элитка: [
                  { name: "Чивас 12 лет", price: 9300},
                  { name: "Балантайс финест", price: 4900},
                  { name: "Джемисон", price:  5400},
                  { name: "Джим Бим", price: 6300},
                  { name: "Ред Лейбел", price: 4500},
                  { name: "Джек Дениелс", price: 6500},
                  { name: "Король Роберт/Кинг Роберт", price: 3500},
                  { name: "Вильямс Лавсон", price: 3500},
                  { name: "Текила обычная", price: 4000},
                  { name: "Текила Олмека", price: 7300},
                  { name: "Капитан Морган", price: 4000},
                  { name: "Бакарди", price: 4000},
                  { name: "Ягерместер/Егерместер", price: 4900},
                  { name: "Джин", price: 2000},
                  { name: "Калуа/Kahlua", price: 4000},
                  { name: "Куантра/Cointreau", price: 4500},
                  { name: "Самбука", price: 3600},
                  { name: "Абсцент", price: 5000},
                  { name: "Апероль", price: 3000},
                  { name: "Бейлис", price: 4700},
                ...
                Вино: [
                  ...
                  { name: "Алазанская Долина красное,белое полусладкое", price: 1300},
                  { name: "Пиросмани красное полусухое", price: 1300},
                ],
            ...
            Напитки: [
              ...
              { name: "Черноголовка", price: 150},
              { name: "Баржоми", price: 220},
              { name: "Энергетик дорогой", price: 220},
              { name: "Энергетик обычный", price: 150},
              { name: "Энергетик 0,25 Редбулл", price: 250},
            ...
            Коктейли: {
                Коктейли_Алкогольные: [
                    {name: "Апероль Спритс", price: 390},
                    {name: "Егерьмонстр", price: 390},
                    {name: "Текила санрайз", price: 390},
                    {name: "Оргазм", price: 660},
                    {name: "Голубая лагуна", price: 390},
                    {name: "Гавайский", price: 390},
                    {name: "Пина колада", price: 450},
                    {name: "Доктор Франк", price: 550},
                    {name: "Глубинная бомба", price: 500},
                    {name: "Белый русский", price: 350},
                    {name: "Сливочный", price: 720},
                    {name: "Виски кола", price: 390},
                    {name: "Снеговик", price: 720},
                    {name: "Мохито", price: 390},
                    {name: "Электрик", price: 880}
                ],
                Коктейли_БезАлкогольные: [
                    {name: "Молочный коктейль", price: 220},
                    {name: "Пина колада ба", price: 330},
                    {name: "Мохито ба", price: 220},
                ],
            },
            Шоты: [
                {name: "Сэт шотов", price: 1250},
                {name: "Сэт русская рулетка", price: 1250},
                {name: "Б-52", price: 390},
                {name: "Барби", price: 390},
                {name: "Горящий Ламборгини", price: 550},
                {name: "Казантип", price: 390},
                {name: "Камикадзе", price: 390},
                {name: "Магия", price: 390},
                {name: "Медуза", price: 390},
                {name: "Мираж", price: 390},
                {name: "Немецкий", price: 390},
                {name: "Опухоль мозга", price: 390},
                {name: "Сабзиро", price: 390},
                {name: "Скорпион", price: 390},
                {name: "Скользкий сосок", price: 390},
                {name: "Хиросима", price: 390},
                {name: "Черный русский", price: 390}
            ]
        ...
        Еда: {
            ...
            Салаты: [
              ...
              { name: "Рыба под шубой", price: 730},
              { name: "Оливье", price: 480},
            ],
            Пицца: {
              Большие: [
            ...
            Закуски: [
              ...
              { name: "Канапе 10шт", price: 600},
              { name: "Брускетт с лососем 1 шт", price: 200},
              { name: "Тарталетки с ветчиной 10шт", price: 1300},
            ],
            Нарезки: [
              { name: "Фруктовая нарезка", price: 400},
              { name: "Овощная нарезка", price: 280},
              { name: "Сырная тарелка", price: 450},
              { name: "Мясное ассорти", price: 600},
              { name: "Сельдь с лимоном", price: 350},
            ],
            Роллы: [
